        ...
        <div class="card">
          <div class="card-header">
            ...
            <h4>Lista de solicitantes
              <a href="solicitante-create.php" class="btn btn-primary float-end">Adicionar Ajuda</a>
            </h4>
                ...
                ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="solicitante-edit.php?id=<?= $solicitante['id_solicitacao'] ?>" class="btn btn-success btn-sm"><span class="bi-pencil-fill"></span>&nbsp;Editar</a>
