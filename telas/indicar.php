            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Indicar alguém que precisa de ajuda
                            <a href="ajuda.html" class="btn btn-danger float-end">Voltar</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        <form action="/logica/acoes.php" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nome_indicador" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label>Telefone</label>
                                <input type="text" name="telefone" class="form-control">
                            </div>
                            <h3>Sobre quem precisa</h3>
                            <div class="mb-3">
                                <label>Nome da pessoa / família / local</label>
                            ...
                            <div class="mb-3">
                                ...
                                <p class="d-flex align-items-center gap-2">
                                    ...
                                    <span class="informacoes" style="color: #6c757d;">
                                        Explique como essa pessoa/comunidade pode ser ajudado (chave PIX ou endereço para doações) e compartilhe brevemente sua história e o motivo da sua necessidade
                                    </span>
                                </p>
                                <textarea
                                    name="descricao"
                                    ...
                                    class="form-control"
                                    rows="5"
                                    placeholder="Descreva a necessidade com o máximo de detalhes possível"></textarea>
                            </div>
                            <div class="mb-3">
                                <button type="submit" name="create_indicacao" class="btn btn-primary">Salvar</button>
                            </div>
                        </form>
                    </div>
